...
namespace ToolKitMarkupProject.Helpers
{
    ...
    {
        private static string rootFolderPattern = null;
#if WINDOWS_UWP
        ...
        private static string FormatLogString(object data = null, string tag = null, string memberName = null, string sourceFilePath = null, int sourceLineNumber = -1)
        {
